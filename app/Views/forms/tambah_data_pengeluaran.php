            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form class="form-horizontal" action="<?= base_url('/home/aksi_tambah_data_pengeluaran')?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_barang" id="nama_transksi" placeholder="Nama Transaksi" class="form-control">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="keterangan" id="keterangan" placeholder="Jumlah" class="form-control">
