...
<div class="col-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      action="
      <?php if ($kunci=='view_lpk') {
        echo base_url('home/print_laporan_keuangan');
        }else{
          echo base_url('');
        }
        ?>" method="post">
      ...
      action="
      <?php if ($kunci=='view_lpk') {
        echo base_url('home/pdf_laporan_keuangan');
        }else{
        echo base_url('');
          }
      ...
      action="
      <?php if ($kunci=='view_lpk') {
        echo base_url('home/excel_laporan_keuangan');
        }else{
          echo base_url('');
        }
        ?>" method="post">
      ...
      action="
      <?php if ($kunci=='view_lpk') {
        echo base_url('home/laporan_keuangan');
        }else{
          echo base_url('');
        }
        ?>" method="post">
